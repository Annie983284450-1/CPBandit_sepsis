...
I
        ...
        final_result_path = './Results' + '(' + f'test{num_test_pat},train{num_train_sepsis_pat+num_train_nosepsis_pat}' + str(self.experts)+')'
        ...
        if not os.path.exists(final_result_path+'/dat'):
        ...
        f_dat_path = os.path.join(final_result_path+'/dat',f_name)
...
def main():
    # experts_list = ['ridge', 'nn','rf']
    # experts_list = ['ridge','rf','svr']  
    experts_list = ['ridge','rf']  
